...
const Section2 = ({
  ...
  return (
    <div
      ref={sectionRef}
      className="h-screen w-full flex flex-col items-center justify-center bg-quantum-purple overflow-hidden px-4 relative"
    >
      {/* Per-section overlay */}
      <div
        ref={overlayRef}
      ...
      >
        Blazing‑fast loading, silky‑smooth interactions. Our performance‑first
        approach—via code optimization, responsive frameworks, and lightweight
        animations—ensures your users get the best experience, no matter the
        device.
      </p>
    </div>
  );
