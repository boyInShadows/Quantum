...
const Section5 = ({
  ...
  return (
    <div
      ref={sectionRef}
      className="h-screen w-full flex flex-col items-center justify-center bg-quantum-navy overflow-hidden px-4 relative"
    >
      {/* Per-section overlay */}
      <div
        ref={overlayRef}
      ...
      >
        Data‑driven design meets quantum‑inspired innovation. We analyze user
        behavior and market trends to shape solutions that work now and grow
        with you—making your site both intuitive and future-ready.
      </p>
    </div>
  );
};
